...
function ContactForm() {
  ...
  const reset = () => {
    formData.name = "";
    formData.email = "";
    formData.interest = "recurring-payments";
    formData.company = "";
    formData.message = "";
  };
  ...
  const handleSubmit = async (e: any) => {
    ...
    fetch("https://formsubmit.co/ajax/support@gingerly.africa", {
      method: "POST",
          ...
          <div className="flex flex-col gap-10 md:gap-20">
            <div className="relative flex flex-col text-center items-center">
              <h2 className="font-medium w-full max-w-32">
                <TextGenerateEffect
                  words="Ready to get started? Get in"
                  duration={0.5}
                />
                <TextGenerateEffect
                  words="touch"
              ...
              <div className="flex flex-col items-center gap-5 text-center max-w-xl mx-auto p-6 rounded-lg bg-green/20 dark:bg-white/5">
                <div className="flex gap-2 items-center">
                  ...
                  <h5 className="text-green dark:text-green">
                    Thank you! We&apos;ll be in touch shortly to discuss your payment needs.
                  </h5>
                </div>
                  ...
                  <div className="w-full">
                    ...
                    >
                      <SelectTrigger className="w-full mt-2 text-base px-5 h-12! rounded-full border transition-all duration-500 dark:border-white/20 focus:outline-0 dark:bg-black/40 focus-visible:ring-0 shadow-none">
                        <SelectValue placeholder="Recurring Payments" />
                      </SelectTrigger>
                      <SelectContent>
                        <SelectItem value="recurring-payments">Recurring Payments</SelectItem>
                        <SelectItem value="rent-collection">Rent Collection</SelectItem>
                        <SelectItem value="school-fees">School Fee Management</SelectItem>
