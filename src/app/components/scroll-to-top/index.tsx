  ...
  return (
    <div className="fixed bottom-8 right-8 z-999">
      <div className="flex items-center gap-2.5">
        <Link href="/contact" className="hidden lg:block bg-purple_blue text-sm hover:bg-purple_blue/90 text-white px-4 py-3.5 leading-none rounded-lg font-medium text-nowrap">
          Get Started
        </Link>
        {isVisible && (
          <div
